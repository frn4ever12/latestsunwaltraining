            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="testimonial-card">
                        ...
                        <h5 class="fw-bold">राम बहादुर</h5>
                        <small class="text-muted">तालिम सहभागी, वार्ड ५</small>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card">
                        ...
                        <h5 class="fw-bold">शिक्षक राम शर्मा</h5>
                        <small class="text-muted">तालिम प्रशिक्षक</small>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card">
                        ...
                        <h5 class="fw-bold">मेयर</h5>
                        <small class="text-muted">सुनवल नगरपालिका</small>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card">
                        ...
                        <h5 class="fw-bold">प्रमुख प्रशासकीय अधिकारी</h5>
                        <small class="text-muted">सुनवल नगरपालिका</small>
                    </div>
                </div>
            </div>
